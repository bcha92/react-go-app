...
func (m *DBModel) All(genre ...int) ([]*Movie, error) {
	...
	query := fmt.Sprintf(`select id, title, description, year, release date, rating, runtime,  mpaa_rating,
...
func (m *DBModel) UpdateMovie(movie Movie) error {
	...
	stmt := `update movies set title = $1, description = $2, year = $3, release_date = $4, runtime = $5, rating = $6, mpaa_rating = $7, created_at = $8, updated_at = $9`
...
func (m *DBModel) DeleteMovie(id int) error {
	...
	stmt := "delete from movies whwere id = $1"
